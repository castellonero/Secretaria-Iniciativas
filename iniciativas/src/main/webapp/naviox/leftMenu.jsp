	...
	<div id="modules_list_top"> 
		...
		<div id="application_title">
			...
			<div id="application_name">
			  <%-- Nacho Añado este párrafo para insertar el logo del ayuntamiento 08/07/2022--%>
				<p>
					<img width="150px" alt="Ajuntament de Castelló de la Plana. Anar a la pàgina d'inici" src="<%=request.getContextPath()%>/xava/images/castello_logo_val.png">
				</p>
			  <%-- Añado este párrafo para insertar el logo del ayuntamiento --%>
