...
<!--<p><img width="250px" alt="Ajuntament de Castelló de la Plana. Anar a la pàgina d'inici" src="http://webpre.castello.es:8080/o/castellon-theme/images/castellon/castello_logo_val.png"></p>-->
<p><img width="250px" alt="Ajuntament de Castelló de la Plana. Anar a la pàgina d'inici" src="<%=request.getContextPath()%>/xava/images/castello_logo_val.png"></p>
